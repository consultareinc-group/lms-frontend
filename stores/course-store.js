  ...
  actions: {
    ...
    GetCourses(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(`lms/course?offset=${request.offset}`)
          .then((response) => {
    ...
    GetPublishedCourses(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(`lms/examinee/course?offset=${request.offset}`)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    GetPublishedCourse(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(`lms/examinee/course/${request.id}`)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    SearchPublishedCourses(request) {
      return new Promise((resolve, reject) => {
    ...
    SearchCourses(request) {
      return new Promise((resolve, reject) => {
        // Make a GET request to fetch courses matching the search keyword
        api
          .get(`lms/course?search_keyword="${request.keyword}"`)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    PutCourse(request) {
      return new Promise((resolve, reject) => {
        // Make a POST request to insert courses in the database courses table
        api
          .put(`lms/course/${request.id}`, request)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    GetQuizzes(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(
            `lms/quiz?offset="${request.offset}"&course_id=${request.course_id}`
          )
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
    ...
    SearchQuizzes(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(`lms/quiz?search_keyword="${request.keyword}"`)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    PutQuiz(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .put(`lms/quiz/${request.id}`, request)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
    ...
    GetQuestions(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(
            `lms/question?offset="${request.offset}"&quiz_id=${request.quiz_id}"`
          )
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
    ...
    SearchQuestions(request) {
      return new Promise((resolve, reject) => {
        ...
        api
          .get(
            `lms/question?search_keyword="${request.keyword}&quiz_id=${request.quiz_id}"`
          )
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
    ...
    PutQuestion(request) {
      return new Promise((resolve, reject) => {
        // Make a PUT request to update quiz in the database quiz table
        api
          .put(`lms/question/${request.id}`, request)
          .then((response) => {
            resolve(response.data); // Resolve the promise with the API response data
          })
          .catch((response) => {
